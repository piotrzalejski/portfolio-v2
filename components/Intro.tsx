    ...
    >
      ...
      >
        ...
        <div className='flex flex-row gap-2'>
          <a
            className='bg-white text-dark/70 p-4 flex items-center  rounded-full active:scale-95 transition outline-none cursor-pointer border border-black/10 hover:scale-110 hover:text-dark
        '
